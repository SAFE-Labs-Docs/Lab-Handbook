...
>- **Flexibility:** Science’s inherent flexibility allows for personal scheduling outside [core work hours](https://www.notion.so/Hours-home-office-absence-days-bb2611db29dc4f8a971032f3740ead53?pvs=21). The PI respects work preferences and encourages the full use of [vacation days](https://www.notion.so/Vacation-and-holidays-e9f901a0e6204f7b9254c8df69ba4481?pvs=21).
>- **Meetings and events:** Meetings will typically be during [core hours only](https://www.notion.so/Hours-home-office-absence-days-bb2611db29dc4f8a971032f3740ead53?pvs=21). The PI avoids communication outside these hours unless urgent, respecting personal time. Lab members are not expected to be responsive outside core hours, in particular when using asynchronous media such as slack or email. Participation at social or networking events is encouraged but not mandatory.
