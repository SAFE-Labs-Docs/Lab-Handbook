...
The importance of welfare, equity—both within and between research groups—and sustainability in academic science has become increasingly evident in recent years. However, we feel that there are 2 gaps to be addressed:
-To create a positive, inclusive, and productive research environment, group leaders need a code of practice with practical action points. Existing training and resources typically provide general advice, not specific policies, and often focus on established labs, which are the least likely to change.
-The code of practice adopted by each lab is too often not documented, neither publicly nor within the lab, making it hard for current group members to shape it and hold the leader accountable, and for perspective group members to know what they buy into.
-Something about institutions

We addressed these issue at the SAFE Labs 2024 workshop, where we created and launched the SAFE Labs handbook: an international engagement initiative, bringing together new bioscience group leaders from across Europe to discuss Starting Aware, Fair, and Equitable Labs. 
<br/>

The handbook presents core commitments that span different topics: Policies, Teams, and Careers. No commitment relies on institutional support to implement, and all commitments are actionable, and can be verifiably implemented. This is because:
...
Besides inspiring new group leaders, a key goal of the handbook is to increase transparency and minimise any expectation mismatch between the group leader and lab members to create positive and equitable lab culture. In fact, we recognise that there are many viable strategies to run a research group; moreover, challenges and constraints vary across groups, institutions, and countries. Therefore, the core commitments can be adopted as presented, or tailored to each lab research strategy, institution and country. We encourage suggestions for new policies and invite discussion for new ideas.
